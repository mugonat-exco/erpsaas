    ...
    <div class="fi-simple-layout flex min-h-screen">
        ...
        <div class="relative hidden w-0 flex-1 lg:block">
            <img class="absolute inset-0 size-full object-cover"
                 src="{{ asset('img/aiva-apsite-Os0UuzbfSck-unsplash.jpg') }}"
                 alt="">
        </div>

        <div
            class="fi-simple-main-ctn flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 w-1/2 bg-white dark:bg-gray-900"
        >
            <main
                @class([
